...
import { Plus, Search, Filter, Edit, Trash2, Eye, Package, AlertCircle, CheckCircle, XCircle } from "lucide-react"
...
const Products = () => {
  ...
  const getProductStats = () => {
    return {
      total: totalProducts,
      active: products.filter((p) => p.status === "active" && p.stock > 10).length,
